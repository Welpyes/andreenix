...
proot-distro login fedora --shared-tmp -- /bin/bash -c 'wget https://raw.githubusercontent.com/Welpyes/Proot-distro-install-Guide/refs/heads/main/proot-distro/account-creation.sh && bash account-creation.sh && exit'
